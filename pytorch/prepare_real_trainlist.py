...
train_path = 'data/real_image_train/'
save_path = 'data/aicity20_all/image_train/'

#---------prepare training all set-------
xmldoc = minidom.parse('data/real_train_label_utf8.xml')
...
fid = open('data/real_trainval_list.txt','w')
